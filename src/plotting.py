...
def plotter(df, independent_variable:str, dependent_variable:str, dependent_variable_halfband:str, legend_loc:str='best', show:bool=False, save_path=None):
    ...
    if isinstance(save_path,str): plt.savefig(save_path)
    if show: plt.show()
